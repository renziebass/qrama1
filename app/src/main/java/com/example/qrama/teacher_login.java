...
public class teacher_login extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        notTeacher = findViewById(R.id.notTeacher);
        notTeacher.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        BLoginTeacher.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
